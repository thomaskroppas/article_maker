...
- [x] **T-4. LLM-слой: клиент, загрузчик промптов, учёт стоимости, MockLLMClient.**
...
- [x] **T-7. Оркестратор Celery: статусы, события, ревью-пауза.**
...
- [x] **T-12. WebSocket + восстановление состояния.**
...
- [x] **T-13. Frontend: экраны Этапа 1.**
